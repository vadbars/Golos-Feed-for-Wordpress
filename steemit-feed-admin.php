...
function mn_steemit_settings_page() {
    ...
    <?php if( $sfi_active_tab == 'support' ) { //Start Support tab ?>
        ...
        <p><i class="fa fa-life-ring" aria-hidden="true"></i>&nbsp; <?php _e('<a href="https://steemit.com/@wordpress-tips/" target="_blank">Click here for setup instructions</a>', 'steemit-feed'); ?></p>
    ...
    <div class="sfi_share_plugin">
        ...
        <!-- TWITTER -->
        <a href="https://twitter.com/share" class="twitter-share-button" data-url="https://steemit.com/@wordpress-tips/" data-text="A simple Wordpress plugin that displays a feed of your Steemit posts." data-via="Minitek_gr" data-dnt="true">Tweet</a>
        ...
        <div class="fb-like" data-href="https://steemit.com/@wordpress-tips/" data-layout="button_count" data-action="like" data-show-faces="false" data-share="true" style="display: block; float: left; margin-right: 20px;"></div>
